...
/* get true or false if one assignment is overlapped  by the other elf */
bool doOverlap(std::string elfPair)
{
    ...
    if (rangeElf1.first <= rangeElf2.first && rangeElf1.second >= rangeElf2.second)
        ...
        return true;
    else if (rangeElf1.first <= rangeElf2.first && rangeElf2.first <= rangeElf1.second)
        return true;
    else if (rangeElf2.first <= rangeElf1.first && rangeElf1.first <= rangeElf2.second)
        return true;
    else
        return false;
}
